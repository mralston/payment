...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('payment_products', function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE `payment_products` MODIFY COLUMN `deferred_type` enum('months','payments') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL AFTER `deferred`");
        });
    }
};
