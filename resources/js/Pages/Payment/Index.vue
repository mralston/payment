            ...
            <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr v-for="payment in payments.data" :key="payment.id">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ payment.addresses.length > 0 ? payment.addresses[0]?.post_code : '-' }}</td>
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ payment.apr }}%</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ payment.loan_term }}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ payment.deferred_period ?? '-' }}</td>
